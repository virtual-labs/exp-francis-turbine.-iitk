...
function calculate(){
    ...
    function checkYourResult(){
        ...
        if(t26.querySelector("input").value!=1.254){
        ...
        if(t28.querySelector("input").value!=0.135){
            t28.querySelector("input").style.color="red"
            flag=false
        }

        if(t29.querySelector("input").value!=1.660){
        ...
        if(t34.querySelector("input").value!=1.538){
        ...
        if(t36.querySelector("input").value!=0.135){
            t36.querySelector("input").style.color="red"
            flag=false
        }
        if(t37.querySelector("input").value!=2.036){
        ...
        if(t41.querySelector("input").value!=1.687){
        ...
        if(t43.querySelector("input").value!=0.135){
            t43.querySelector("input").style.color="red"
            flag=false
        }

        if(t44.querySelector("input").value!=2.234){
        ...
        if(t48.querySelector("input").value!=1.883){
        ...
        if(t50.querySelector("input").value!=0.135){
            t50.querySelector("input").style.color="red"
            flag=false
        }
        if(t51.querySelector("input").value!=2.494){
    ...
    function exportToExcel() {
        ...
        /* Calculation Table */
        var calculationTable = document.querySelector('.result-table');
